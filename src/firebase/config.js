...
const firebaseConfig = {
  apiKey: readConfig('REACT_APP_FIREBASE_API_KEY', 'AIzaSyBN1BIMrn2XsiLaWgI5wmPBPt6xfzUVI9s'),
  ...
  measurementId: readConfig('REACT_APP_FIREBASE_MEASUREMENT_ID', 'G-HC7CKL0KP4'),
};
